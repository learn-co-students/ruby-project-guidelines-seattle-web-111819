...
Review.find_or_create_by(user_id: 15, game_id: 3, rating: 50, review_text: "<EMPTY>")
Review.find_or_create_by(user_id: 16, game_id: 3, rating: 10, review_text: "<EMPTY>")
